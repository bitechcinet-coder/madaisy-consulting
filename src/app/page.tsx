        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-[#fafaf9] px-10 py-10 rounded-3xl">
            <div className="flex items-center gap-6">
              <div className="text-primary text-7xl font-light tracking-tighter">5/5</div>
              <div>
                <p className="text-xl font-semibold text-slate-900">Dossiers acceptés</p>
                <p className="text-slate-500 text-sm">Depuis juin 2024 · 100% de réussite</p>
              </div>
            </div>
            ...
            <p className="text-slate-500 max-w-md italic text-center md:text-left text-base font-light leading-relaxed">
              &ldquo;5 dossiers, 5 admissions, 3 villes : Paris, Toulouse et Montpellier.&rdquo;
            </p>
          </div>
        </div>
      </section>
