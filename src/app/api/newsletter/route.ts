  ...
  try {
    ...
    if (process.env.RESEND_API_KEY) {
      sendEmail({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;color:#333"><h2 style="color:#E6050C">Bienvenue chez Madaisy Consulting</h2><p>Bonjour,</p><p>Nous vous confirmons votre inscription à la newsletter de <strong>Madaisy Consulting</strong>.</p><p>Vous recevrez désormais nos actualités, conseils et offres exclusives directement dans votre boîte mail.</p><p style="margin-top:20px">À très bientôt,</p><p><strong>L'équipe Madaisy Consulting</strong></p><hr style="border:none;border-top:1px solid #ddd;margin:20px 0"><p style="color:#888;font-size:12px">Si vous souhaitez vous désinscrire, répondez simplement à cet email avec « Désinscription » en objet.</p></div>`,
